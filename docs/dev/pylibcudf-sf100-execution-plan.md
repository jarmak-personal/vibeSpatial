...
Artifacts: `benchmark_results/spatialbench/sf100/2026-08-14-final-median/final_benchmark.json`, `final_telemetry.json`, `telemetry_summary.json`, `same_data_correctness.json`, `pipeline_profile_summary.json`, and `provenance.json`. Per-query semantics, physical shapes, memory formulas, and measurement evidence are checked in at `docs/dev/pylibcudf-sf100-query-ledger.md`.
