...
# ---------------------------------------------------------------------------
# NVRTC kernel source: Circle-to-polygon tessellation
#
# Given (cx, cy, radius) per geometry, produce N_VERTS+1 coordinates
# (closed ring) for each circle polygon.
#
# ADR-0033 Tier 1: per-geometry trigonometric loop.
# ---------------------------------------------------------------------------
