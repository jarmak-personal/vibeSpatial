...
def normalize_bounds_tuple(value: BoundsValue) -> tuple[float, float, float, float]:
...
def point_within_bounds_cpu(
    ...
    *,
    ...
    right = normalize_right_input(polygons_or_bounds, expected_len=left.row_count)
    ...
    result = evaluate_point_within_bounds(left, right)
