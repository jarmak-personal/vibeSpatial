...
from vibespatial.spatial_query_candidates import (  # noqa: E402
    _generate_candidates_gpu,
    _generate_distance_pairs,
)
from vibespatial.spatial_query_types import (  # noqa: E402
    RegularGridPointIndex,
    _DeviceCandidates,
)
from vibespatial.spatial_query_utils import (  # noqa: E402
    _as_geometry_array,
    _expand_bounds,
...
def _tree_distance_family(tree_owned: OwnedGeometryArray) -> GeometryFamily | None:
    ...
    """
    from vibespatial.point_distance import supported_point_distance_families
...
def _make_point_owned_from_coords(x: np.ndarray, y: np.ndarray) -> OwnedGeometryArray:
    ...
    """
    from vibespatial.geometry_buffers import POINT_SCHEMA
