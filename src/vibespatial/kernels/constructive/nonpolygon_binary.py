...
# ---------------------------------------------------------------------------
# NVRTC kernel sources
# ---------------------------------------------------------------------------

# Point-LineString: compute minimum distance from point to each segment
# of a linestring. intersection = keep if on line (dist == 0),
# difference = keep if not on line (dist > 0).
...
# LineString-Polygon intersection/difference: clip line segments against polygon.
# Uses PIP for segment endpoints + edge crossing detection.
...
# LineString-LineString intersection: find intersection points between pairs
# of linestrings.
