"""CUDA kernel source for spatial query operations.

Contains NVRTC kernel source strings and kernel name tuples for:
- Spatial query kernels (bbox overlap, point-in-grid, distance pairs)
- Morton range kernels (Z-order curve range queries)
- Grid nearest kernels (uniform-grid nearest-neighbour search)
