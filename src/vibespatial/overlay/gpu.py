...
# Split event generation and atomic edge construction have been extracted
# to overlay/split.py.  Re-export for backward compatibility.
# Half-edge graph construction and face walk have been extracted to
# overlay/graph.py.  Re-export for backward compatibility.
...
# Face labeling, selection, and assembly have been extracted to
# overlay/faces.py.  Re-export for backward compatibility.
