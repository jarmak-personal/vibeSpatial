...
def test_evaluate_check_report_ignores_gpu_value_dispatch_jitter_within_tenth_point() -> None:
    report = {
        "tier": "gpu",
        "status": "fail",
        "exit_code": 1,
        "gpu_acceleration": {
            "gpu_accel_pct": 21.46929619590616,
            "raw_dispatch_pct": 21.46929619590616,
            "value_dispatch_pct": 65.93674956245675,
            "total_dispatches": 21398,
            "fallback_dispatches": 31,
        },
    }
    baseline = {
